...
public class FrogRiverOneChallenge {
//    A small frog wants to get to the other side of a river.
//    The frog is initially located on one bank of the river (position 0)
//    and wants to get to the opposite bank (position X+1). Leaves fall from a
...
//    You may assume that the speed of the current in the river is negligibly small, i.e. the leaves do not
...
//    solved 100 % correctness and performance

    public static int solution(int X, int[] A) {

        Set<Integer> savedLeaves = new HashSet<>(X);
        int timeCounter = -1;
