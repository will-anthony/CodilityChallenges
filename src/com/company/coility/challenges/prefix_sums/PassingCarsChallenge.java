package com.company.coility.challenges.prefix_sums;

public class PassingCarsChallenge {
...
//
//            if (array[index] == 0) {
//                for (int j = arrayElementCounter; j < array.length; j++) {
//                    if (array[j] == 1) {
//                        passingCarsCounter ++;
//                    }
//
...
//    100% performance, 100% correctness
    public static int solution(int[] array) {
        ...
        for (int index = 0; index < array.length; index++) {
            if (array[index] == 0) {
                passingCarsCounter += numberOfOnes;
                if (passingCarsCounter > 1000000000) {
                    return -1;
                }
